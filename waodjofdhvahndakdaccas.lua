    ...
    btn.MouseButton1Click:Connect(function()
        ...
        function Tab:AddCollapse(text,build)
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                holder.Size = open and UDim2.new(1,0,0,40+lay.AbsoluteContentSize.Y+8) or UDim2.new(1,0,0,40)
                inner.Size = open and UDim2.new(1,0,0,lay.AbsoluteContentSize.Y) or UDim2.new(1,0,0,0)
            end)
